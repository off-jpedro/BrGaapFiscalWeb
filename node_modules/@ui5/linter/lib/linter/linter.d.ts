...
export declare function lintProject({ rootDir, filePatterns, ignorePatterns, coverage, details, configPath, ui5Config, noConfig, }: LinterOptions, sharedLanguageService: SharedLanguageService): Promise<LintResult[]>;
export declare function lintFile({ rootDir, filePatterns, ignorePatterns, namespace, coverage, details, configPath, noConfig, }: LinterOptions, sharedLanguageService: SharedLanguageService): Promise<LintResult[]>;
