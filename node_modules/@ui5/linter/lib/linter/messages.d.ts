...
export declare enum MESSAGE {
    ...
    PARSING_ERROR = 39,
    PARTIALLY_DEPRECATED_CORE_ROUTER = 40,
    PARTIALLY_DEPRECATED_CREATE_COMPONENT = 41,
    PARTIALLY_DEPRECATED_JSON_MODEL_LOAD_DATA = 42,
    PARTIALLY_DEPRECATED_MOBILE_INIT = 43,
    PARTIALLY_DEPRECATED_ODATA_MODEL_V2_CREATE_ENTRY = 44,
    PARTIALLY_DEPRECATED_ODATA_MODEL_V2_CREATE_ENTRY_PROPERTIES_ARRAY = 45,
    PARTIALLY_DEPRECATED_PARAMETERS_GET = 46,
    PARTIALLY_DEPRECATED_VIEW_CREATE = 47,
    PARTIALLY_DEPRECATED_FRAGMENT_LOAD = 48,
    PARTIALLY_DEPRECATED_CONTROLLER_LOAD_FRAGMENT = 49,
    PREFER_TEST_STARTER = 50,
    REDUNDANT_BOOTSTRAP_PARAM = 51,
    REDUNDANT_BOOTSTRAP_PARAM_ERROR = 52,
    REDUNDANT_VIEW_CONFIG_PROPERTY = 53,
    REPLACED_BOOTSTRAP_PARAM = 54,
    SPELLING_BOOTSTRAP_PARAM = 55,
    STRING_FOR_FORMATTER_VALUE_IN_JS = 56,
    SVG_IN_XML = 57,
    MISSING_CONTROL_RENDERER_DECLARATION = 58,
    CONTROL_RENDERER_DECLARATION_STRING = 59
}
