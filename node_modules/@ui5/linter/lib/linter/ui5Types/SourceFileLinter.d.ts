...
export default class SourceFileLinter {
    ...
    constructor(context: LinterContext, resourcePath: ResourcePath, sourceFile: ts.SourceFile, sourceMaps: Map<string, string> | undefined, checker: ts.TypeChecker, reportCoverage: boolean | undefined, messageDetails: boolean | undefined, apiExtract: ApiExtract, filePathsWorkspace: AbstractAdapter, workspace: AbstractAdapter, manifestContent?: string | undefined);
    lint(): Promise<void>;
