...
function addSapui5TypesMappingToCompilerOptions(sapui5TypesFiles, options, projectNamespace) {
...
export async function createVirtualLanguageServiceHost(options, files, sourceMaps, context, projectScriptVersion) {
    ...
    typePathMappings.set("@ui5/linter/overrides", path.dirname(require.resolve("../../../resources/overrides/package.json")));
