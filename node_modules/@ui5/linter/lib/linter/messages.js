...
(function (MESSAGE) {
    ...
    MESSAGE[MESSAGE["DEPRECATED_MODULE_IMPORT_NAMED"] = 17] = "DEPRECATED_MODULE_IMPORT_NAMED";
    MESSAGE[MESSAGE["DEPRECATED_MODULE_IMPORT"] = 18] = "DEPRECATED_MODULE_IMPORT";
    MESSAGE[MESSAGE["DEPRECATED_ODATA_MODEL_V4_SYNCHRONIZATION_MODE"] = 19] = "DEPRECATED_ODATA_MODEL_V4_SYNCHRONIZATION_MODE";
    MESSAGE[MESSAGE["DEPRECATED_PROPERTY"] = 20] = "DEPRECATED_PROPERTY";
    MESSAGE[MESSAGE["DEPRECATED_PROPERTY_OF_CLASS"] = 21] = "DEPRECATED_PROPERTY_OF_CLASS";
    MESSAGE[MESSAGE["DEPRECATED_THEME"] = 22] = "DEPRECATED_THEME";
    MESSAGE[MESSAGE["DEPRECATED_VIEW_TYPE"] = 23] = "DEPRECATED_VIEW_TYPE";
    MESSAGE[MESSAGE["DUPLICATE_BOOTSTRAP_PARAM"] = 24] = "DUPLICATE_BOOTSTRAP_PARAM";
    MESSAGE[MESSAGE["HTML_IN_XML"] = 25] = "HTML_IN_XML";
    MESSAGE[MESSAGE["LIB_INIT_API_VERSION"] = 26] = "LIB_INIT_API_VERSION";
    MESSAGE[MESSAGE["MISSING_BOOTSTRAP_PARAM"] = 27] = "MISSING_BOOTSTRAP_PARAM";
    MESSAGE[MESSAGE["NO_AMBIGUOUS_EVENT_HANDLER"] = 28] = "NO_AMBIGUOUS_EVENT_HANDLER";
    MESSAGE[MESSAGE["NO_CONTROL_RERENDER_OVERRIDE"] = 29] = "NO_CONTROL_RERENDER_OVERRIDE";
    MESSAGE[MESSAGE["NO_DEPRECATED_RENDERER"] = 30] = "NO_DEPRECATED_RENDERER";
    MESSAGE[MESSAGE["NO_DIRECT_DATATYPE_ACCESS"] = 31] = "NO_DIRECT_DATATYPE_ACCESS";
    MESSAGE[MESSAGE["NO_DIRECT_ENUM_ACCESS"] = 32] = "NO_DIRECT_ENUM_ACCESS";
    MESSAGE[MESSAGE["NO_EXPORTED_VALUES_BY_LIB"] = 33] = "NO_EXPORTED_VALUES_BY_LIB";
    MESSAGE[MESSAGE["NO_GLOBALS"] = 34] = "NO_GLOBALS";
    MESSAGE[MESSAGE["NO_ICON_POOL_RENDERER"] = 35] = "NO_ICON_POOL_RENDERER";
    MESSAGE[MESSAGE["NO_LEGACY_TEMPLATE_REQUIRE_SYNTAX"] = 36] = "NO_LEGACY_TEMPLATE_REQUIRE_SYNTAX";
    MESSAGE[MESSAGE["NO_ODATA_GLOBALS"] = 37] = "NO_ODATA_GLOBALS";
    MESSAGE[MESSAGE["NOT_STATIC_CONTROL_RENDERER"] = 38] = "NOT_STATIC_CONTROL_RENDERER";
    MESSAGE[MESSAGE["PARSING_ERROR"] = 39] = "PARSING_ERROR";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_CORE_ROUTER"] = 40] = "PARTIALLY_DEPRECATED_CORE_ROUTER";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_CREATE_COMPONENT"] = 41] = "PARTIALLY_DEPRECATED_CREATE_COMPONENT";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_JSON_MODEL_LOAD_DATA"] = 42] = "PARTIALLY_DEPRECATED_JSON_MODEL_LOAD_DATA";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_MOBILE_INIT"] = 43] = "PARTIALLY_DEPRECATED_MOBILE_INIT";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_ODATA_MODEL_V2_CREATE_ENTRY"] = 44] = "PARTIALLY_DEPRECATED_ODATA_MODEL_V2_CREATE_ENTRY";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_ODATA_MODEL_V2_CREATE_ENTRY_PROPERTIES_ARRAY"] = 45] = "PARTIALLY_DEPRECATED_ODATA_MODEL_V2_CREATE_ENTRY_PROPERTIES_ARRAY";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_PARAMETERS_GET"] = 46] = "PARTIALLY_DEPRECATED_PARAMETERS_GET";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_VIEW_CREATE"] = 47] = "PARTIALLY_DEPRECATED_VIEW_CREATE";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_FRAGMENT_LOAD"] = 48] = "PARTIALLY_DEPRECATED_FRAGMENT_LOAD";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_CONTROLLER_LOAD_FRAGMENT"] = 49] = "PARTIALLY_DEPRECATED_CONTROLLER_LOAD_FRAGMENT";
    MESSAGE[MESSAGE["PREFER_TEST_STARTER"] = 50] = "PREFER_TEST_STARTER";
    MESSAGE[MESSAGE["REDUNDANT_BOOTSTRAP_PARAM"] = 51] = "REDUNDANT_BOOTSTRAP_PARAM";
    MESSAGE[MESSAGE["REDUNDANT_BOOTSTRAP_PARAM_ERROR"] = 52] = "REDUNDANT_BOOTSTRAP_PARAM_ERROR";
    MESSAGE[MESSAGE["REDUNDANT_VIEW_CONFIG_PROPERTY"] = 53] = "REDUNDANT_VIEW_CONFIG_PROPERTY";
    MESSAGE[MESSAGE["REPLACED_BOOTSTRAP_PARAM"] = 54] = "REPLACED_BOOTSTRAP_PARAM";
    MESSAGE[MESSAGE["SPELLING_BOOTSTRAP_PARAM"] = 55] = "SPELLING_BOOTSTRAP_PARAM";
    MESSAGE[MESSAGE["STRING_FOR_FORMATTER_VALUE_IN_JS"] = 56] = "STRING_FOR_FORMATTER_VALUE_IN_JS";
    MESSAGE[MESSAGE["SVG_IN_XML"] = 57] = "SVG_IN_XML";
    MESSAGE[MESSAGE["MISSING_CONTROL_RENDERER_DECLARATION"] = 58] = "MISSING_CONTROL_RENDERER_DECLARATION";
    MESSAGE[MESSAGE["CONTROL_RENDERER_DECLARATION_STRING"] = 59] = "CONTROL_RENDERER_DECLARATION_STRING";
})(MESSAGE || (MESSAGE = {}));
